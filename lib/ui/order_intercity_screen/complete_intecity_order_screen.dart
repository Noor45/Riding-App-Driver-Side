                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                                ...
                                                child: Center(
                                                  child: Row(
                                                    children: [
                                                      Expanded(child: Text(controller.orderModel.value.status.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w500))),
                                                      Text(Constant().formatTimestamp(controller.orderModel.value.createdDate), style: GoogleFonts.inter()),
                                                    ],
                                                  ),
                                                )),
                                          ),
                                                ...
                                                Row(
                                                  children: [
                                                    Expanded(
                                                      child: Text(
                                                        "Ride Amount".tr,
                                                        style: GoogleFonts.inter(color: AppColors.subTitleColor),
                                                      ),
                                                    ),
                                                    Text(
