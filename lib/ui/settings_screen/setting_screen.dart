                                              ...
                                              child: DropdownButtonFormField(
                                                  ...
                                                  items: controller.languageList.map((item) {
                                                    ...
                                                    return DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item.name.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                                                    );
                                                  }).toList()),
                                            ),
                                          ],
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(child: Text("Light/dark mod".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w500))),
                                            SizedBox(
                                              width: Responsive.width(26, context),
                                              child: DropdownButtonFormField<String>(
                                                  ...
                                                  items: controller.modeList.map((item) {
                                                    return DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                                                    );
                                                  }).toList()),
                                            ),
                                          ],
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Support".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                                            ],
                                          ),
                                        ),
                                      ),
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Delete Account".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w500))
                                            ],
                                          ),
                                        ),
                                      )
