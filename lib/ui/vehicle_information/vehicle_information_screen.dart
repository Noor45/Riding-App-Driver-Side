                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("Select Your Rules".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 16)),
                                ListBody(
                                  children: controller.driverRulesList
                                    ...
                                    checkColor: themeChange.getThem() ? AppColors.darkModePrimary : AppColors.primary,
                                            ...
                                            title: Text(item.name.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w400)),
                                            onChanged: (value) {
                                              if (value == true) {
