                              ...
                              children: [
                                ...
                                orderModel.status == Constant.rideComplete || orderModel.status == Constant.rideActive
                                  ...
                                  child: Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(child: Text(orderModel.status.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w600))),
                                          Text(Constant().formatTimestamp(orderModel.createdDate), style: GoogleFonts.inter()),
                                        ],
                                      )),
                                )
                                    : Container(
