...
class _ChatScreensState extends State<ChatScreens> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 2,
        title: Text("${widget.customerName.toString()}\n#${widget.orderId.toString()}", maxLines: 2, style: GoogleFonts.inter(color: Colors.white, fontSize: 14)),
        leading: InkWell(
            onTap: () {
              Get.back();
            },
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text("Me".tr, style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400)),
                      Text(Constant.dateAndTimeFormatTimestamp(data.createdAt), style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400)),
                    ],
                  ),
                ],
              ),
          ...
          : Column(
              ...
              children: [
                  ...
                  children: [
                    data.messageType == "text"
                        ? Container(
                            ...
                            child: Text(
                              data.message.toString(),
                              style: GoogleFonts.inter(color: data.senderId == FireStoreUtils.getCurrentUid() ? Colors.white : Colors.black),
                            ),
                          )
                        : data.messageType == "image"
                            ? ConstrainedBox(
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(widget.customerName.toString(), style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400)),
                    Text(Constant.dateAndTimeFormatTimestamp(data.createdAt), style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400)),
                  ],
                ),
              ],
