                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: ListTile(
                              ...
                              title: Row(
                                children: [
                                  Expanded(child: Text(inboxModel.customerName.toString(),style: GoogleFonts.inter(fontWeight: FontWeight.w600),)),
                                  Text(Constant.dateFormatTimestamp(inboxModel.createdAt), style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w400)),
                                ],
                              ),
