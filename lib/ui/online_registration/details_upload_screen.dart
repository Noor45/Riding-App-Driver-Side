        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
              ...
              centerTitle: true,
              title: Text(controller.documentModel.value.title.toString(), style: GoogleFonts.inter(color: Colors.white)),
              leading: InkWell(
                  onTap: () {
                    Get.back();
                  },
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Front Side of ${controller.documentModel.value.title.toString()}".tr, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Back side of ${controller.documentModel.value.title.toString()}".tr, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
