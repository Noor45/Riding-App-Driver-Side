                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("Verify Phone Number".tr ,style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 18)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 2),
                          child: Text("We just send a verification code to \n${controller.countryCode.value + controller.phoneNumber.value}".tr,style: GoogleFonts.inter()),
                        ),
                        Padding(
