                            ...
                            InkWell(
                                onTap: () async {
                                  BottomPicker.date(
                                    ...
                                    buttonContent: Text('Confirm'.tr, style: TextStyle(color: Colors.white),),
                                    buttonSingleColor: AppColors.primary,
                                    pickerTitle: Text('', style:  GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 15)),
                                  ).show(context);
                                },
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            Text(Constant.amountShow(amount: orderModel.offerRate.toString()), style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 18)),
                                                            orderModel.intercityServiceId == "647f350983ba2"
                                                                ? const SizedBox()
                                                                : Text(" For ${orderModel.numberOfPassenger} Person".tr, style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 18)),
                                                          ],
                                                        ),
                                                        const SizedBox(
                                                          height: 10,
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Padding(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Text(orderModel.whenDates.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
                                                                    const SizedBox(
                                                                      width: 10,
                                                                    ),
                                                                    Text(orderModel.whenTime.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
                                                                  ],
                                                                )),
                                                          ),
                                                        ),
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(Constant.amountShow(amount: controller.newAmount.toString()), style: GoogleFonts.inter()),
                                const SizedBox(
                                  width: 20,
                                ),
