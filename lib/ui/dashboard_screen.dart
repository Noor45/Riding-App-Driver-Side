    ...
    return GetX<DashBoardController>(
        ...
        builder: (controller) {
          return Scaffold(
                              ...
                              GestureDetector(
                                ...
                                child: Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      'Online'.tr,
                                      style: GoogleFonts.inter(color: driverModel.isOnline == true ? Colors.black : Colors.white, fontWeight: FontWeight.w500, fontSize: 14),
                                    ),
                                  ),
                                ),
                              ),
                              GestureDetector(
                                ...
                                child: Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      'Offline'.tr,
                                      style: GoogleFonts.inter(color: driverModel.isOnline == false ? Colors.black : Colors.white, fontWeight: FontWeight.w500, fontSize: 14),
                                    ),
                                  ),
                                ),
                              ),
            ...
            body: WillPopScope(onWillPop: controller.onWillPop, child: controller.getDrawerItemWidget(controller.selectedDrawerIndex.value, context)),
          );
        });
  }
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content:  SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('To start earning with Syara you need to fill in your personal information'.tr),
              ],
            ),
          ),
          actions: <Widget>[
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(driverModel.fullName.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                            ),
                            Padding(
