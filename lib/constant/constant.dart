...
class Constant {
  ...
  static String mapAPIKey = "YOUR KEY HERE";
  ...
  static Timestamp timeStampConvertor(String timestampString) {
    // Extract seconds and nanoseconds using RegExp
  ...
  static Future<String> uploadUserImageToFireStorage(File image, String filePath, String fileName) async {
    // try {
      Reference storageReference = FirebaseStorage.instance.ref().child('$filePath/$fileName');

      SettableMetadata metadata = SettableMetadata(
        cacheControl: 'max-age=3600', // Add some cache control, or leave empty if not needed
        customMetadata: {'uploaded_by': 'user', 'description': 'Document image'},
      );
