      ...
      child: SizedBox(
        ...
        child: MaterialButton(
          ...
          child: Text(
            ...
            style: GoogleFonts.inter(fontSize: txtSize, fontWeight: FontWeight.w600),
          ),
        ),
      ),
    );
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                title.toUpperCase(),
                textAlign: TextAlign.center,
                style: GoogleFonts.inter(color: themeChange.getThem() ? AppColors.darkModePrimary : AppColors.primary, fontSize: txtSize, fontWeight: FontWeight.w600),
              ),
            ],
          ),
        ),
