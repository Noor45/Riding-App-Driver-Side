                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(Constant.amountShow(amount: amount.toString()), style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                                Row(
                                  children: [
                                    const Icon(
                                      Icons.location_on,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(driverModel.fullName.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(Constant.amountShow(amount: amount.toString()), style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(Constant.calculateReview(reviewCount: driverModel.reviewsCount, reviewSum: driverModel.reviewsSum), style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                                ],
                              ),
                            ],
                          )
