...
class FireStoreUtils {
  ...
  Future<CurrencyModel?> getCurrency(String currency) async {
    ...
    await fireStore.collection(CollectionName.currency).where("code", isEqualTo: currency).get().then((value) {
  ...
  static Future<DriverUserModel?> getUserProfile(String uuid) async {
